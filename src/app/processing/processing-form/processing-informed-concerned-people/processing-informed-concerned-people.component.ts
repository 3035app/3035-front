...
@Component({
  selector: 'app-processing-informed-concerned-people',
  templateUrl: './processing-informed-concerned-people.component.html',
  styleUrls: ['./processing-informed-concerned-people.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ProcessingInformedConcernedPeopleComponent),
      multi: true
    }
  ]
})

export class ProcessingInformedConcernedPeopleComponent implements ControlValueAccessor {
