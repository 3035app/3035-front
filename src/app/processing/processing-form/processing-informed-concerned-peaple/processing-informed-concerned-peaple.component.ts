...
@Component({
  selector: 'app-processing-informed-concerned-peaple',
  templateUrl: './processing-informed-concerned-peaple.component.html',
  styleUrls: ['./processing-informed-concerned-peaple.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ProcessingInformedConcernedPeapleComponent),
      multi: true
    }
  ]
})

export class ProcessingInformedConcernedPeapleComponent implements ControlValueAccessor {
